...
<%
'===================================================================================
'File Name:						transaction_report.asp 1600
...
Dim I, Sel
	...
	write_dataLog  Response.Status,"transacction_report.asp", "transacction_report.asp loaded by " & Session("sp_miLogin"),Session("sp_miLogin"),"null","N/A","null","Consulta","N/A"
%>
<HTML>
	<head>
...
//-->
	...
	<body class="cuerpo">
		...
		<div class="header1 master1">
			Reporte Tipo de Transacción
		</div>
<%
OpenForm "date", "post", "transacction_reportsubmit.asp", "onSubmit='return formValidation(this)' id='date'"
