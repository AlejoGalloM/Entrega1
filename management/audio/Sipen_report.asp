...
<%
'===================================================================================
'File Name:						SIPEN_report.asp 1600
'Path:							management/audio
'Created By:					BAH Abril/2007
...
write_dataLog  Response.Status,"SIPEN_report.asp", "Cons_Debits_Otros.asp loaded by " & Session("sp_miLogin"),Session("sp_miLogin"),"null","N/A","null","Consulta","N/A"
...
//-->
	...
	<body class="cuerpo">
		...
		<div class="header1 master1">
			Reporte de Transferencias SIPEN
		</div>
<%
		OpenTable "90%", "'' align=center border=0"
			OpenForm "sel_unit", "post", "SIPEN_reportsubmit.asp", "onSubmit='javascript:return validate(this)'"
