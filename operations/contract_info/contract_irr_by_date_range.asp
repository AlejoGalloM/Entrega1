...
write_sp_log objConn, 8800, "", Contract, Product, "", ClientId, 0, "", "contract_irr_by_date_range.asp loaded by " & _
Session.Contents("sp_milogin")

write_dataLog Response.Status,"contract_irr_by_date_range.asp","contract_irr_by_date_range.asp " &"- " & Session("sp_miLogin"),Session.contents("name"),"null" ,"N/A","null","Consulta","N/A"
...
<%
		...
		OpenTable "70%","border=0"
			OpenTable "80%", "t_table align=center"
				...
				OpenTr "class=teven"
					OpenTd "thead", "align=center colspan=3"
						Response.Write "Consulta a rangos de fechas"
					CloseTd
				CloseTr
				OpenTr ""
					OpenTd "", "align=center colspan=3"
				...
				OpenTr ""
					...
					CloseTd
					OpenForm "sel_irr_date", "post", "contract_irr_by_date_range_process.asp", ""
