...
<%
'===================================================================================
'File Name:					QueryFilterContractbyEstadoCto.asp  19307
'Path:						/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp
...
Dim bc
Dim rstcampo
Dim arrProducto, arrSociedades, arrAgente, arrWsaler
...
'write_sp_log adoConn, 19307, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin")
'write_sp_log adoConn, 19307, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " acclev " & Cstr(Session("sp_AccessLevel"))
write_sp_log adoConn, 13359, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin")
write_sp_log adoConn, 13359, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " acclev " & Cstr(Session("sp_AccessLevel"))
CloseConnPipelineDB
Set adoConn = Nothing
...
function get_sociedad( idsociedad,WSALER )
		...
		Sql1= replace(Sql,"'","")
		'write_sp_log adoConn, 19307, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
		write_sp_log adoConn, 13359, "sigscg.dbo.spcm_getsociedadfp", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
...
function get_agente(par_idagte, par_idsociedad,  par_WSALER )
		...
		Sql1= replace(Sql,"'","")
		'write_sp_log adoConn, 19307, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
		write_sp_log adoConn, 13359, "sigscg.dbo.spcm_getagente", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
...
function get_producto()
		...
		Set adoConn = GetConnpipelineDB()		
		Set rstCampo = Server.CreateObject("ADODB.Recordset")
		Sql = "exec sigscg.dbo.Spsp_GetComboProducts"

		Sql1= replace(Sql,"'","")
		'write_sp_log adoConn, 19307, "", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
		write_sp_log adoConn, 13359, "sigscg.dbo.Spsp_GetComboProducts", 0, "", "", 0, 0, "", "/sistinfodist/Selling/QueryFilterContractbyEstadoCto.asp Loaded by " & Session("sp_miLogin") & " sql " & sql1
		rstCampo.Open Sql, adoConn
		If rstCampo.BOF And rstCampo.EOF Then
			arrProducto = 0
		Else
			arrProducto = rstCampo.GetRows()
		End If
...
PlaceTitle "QueryFilterContractbyEstadoCto"
...
{	
	...
	{
			document.frProducto.pagina1.value="QueryFilterContractbyEstadoCto.asp";
	...
	else
	{
		...
		{
			if ( (document.frProducto.producto0.selectedIndex==null ) || (document.frProducto.producto0.selectedIndex==-1) ||document.frProducto.idAgte0.selectedIndex==0 )
			{
					document.frProducto.pagina1.value="QueryFilterContractbyEstadoCto.asp";
					frProducto.action=document.frProducto.pagina1.value;		
			...
			{		
				...
				//especifico para consulta afiliaciones o contratos nuevos que estén esperando la entrada de dinero
				document.frProducto.EstadoContrato1.value	="AP";
				...
				document.frProducto.pagina0.value			="./contractByEstadoCto.asp";
				document.frProducto.pagina1.value			="./contractByEstadoCto.asp";
...
OpenTable "90%", " align=center cellpadding=0 cellspacing=0"
	...
	OpenTr "valign=middle"
		OpenTd "''", "align=center valign=middle colspan=2"
			Response.Write "<h3> Consulta Contratos por Estado del Contrato </h3>"
		CloseTd
	CloseTr
	OpenTr "valign=middle"
		OpenTd "''", "align=center valign=middle colspan=2"
...
OpenTable "75%", "'' align=center"	
	OpenTr "valign=top"
		...
		OpenTd "", ""
			dim p
			OpenCombo "producto0", ""
	    		For J = 0 To UBound(arrProducto,2)
	    			p=trim(arrProducto(0,J))
					if (p="MFUND" or p="SIPEN" or p="MTCOR") then
						PlaceItem Sel, arrProducto(0,J), arrProducto(1,J)
					end if
				Next 'J
			CloseCombo
		CloseTd
...
OpenTable "75%", "'' align=center"	
	OpenTr "class=teven"
		OpenTd "thead", "width=20% align=left"
			Response.Write "Estado del Contrato" 
		CloseTd
		OpenTd "teven", "align=left "
			Response.Write "Contratos Esperando Dinero -AP" 
			'PlaceInput "EstadoContrato", "Input", EstadoContrato1 ,""
		CloseTd
...
OpenTable "75%", "'' align=center height=14"
	...
	OpenTr "class=todd"
		...
		PlaceInput "EstadoContrato1","hidden","","AV"
		...
		PlaceInput "pagina0","hidden","./QueryFilterContractbyEstadoCto.asp",""
